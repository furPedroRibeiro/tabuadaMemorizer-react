    ...
    return(
        <Dialog.Root>
            <Dialog.Trigger className='w-11/12 md:w-auto'>
                <button onClick={handleMultiplicationTable} className="bg-stone-950 text-amber-400 text-base w-[200px] px-4 py-3 rounded-md hover:bg-stone-900 transition-colors duration-300 outline-none">Ver tabuada</button>
            </Dialog.Trigger>
            <Dialog.Portal>
